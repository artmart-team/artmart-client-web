  ...
  return (
    <div id="HomeCard" className="col-6 col-sm-6 col-md-4 col-lg-3 col-xxl-2">
      <div className="card" style={{ width: '100%', borderRadius: 8, marginTop: 8, marginBottom: 8 }}>
        ...
        <div onClick={() => handleGoToArtistPage()} style={{ cursor: 'pointer' }}>
        ...
        <div className="card-body d-flex">
          <div style={{ marginRight: 4, flex: 1 }}>
            <Link to={`/artist/${picture.ArtistId}`}>
              <img
          ...
          <div style={{ flex: 3, minWidth: 0 }}>
            <Link to={`/stall/${picture.ArtistId}`} style={{ textDecoration: 'none' }}>
              <h5 className="card-title" style={{ width: 'auto', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{picture.name}</h5>
            </Link>
            <p className="card-text" style={{ minWidth: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{picture?.Artist.username}</p>
          </div>
        ...
        {/* <div className="card-body">
          <div className="row">
            ...
            <div className="col-12 col-sm-8">
              <h5 className="card-title" style={{ width: 'auto', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{picture.name}</h5>
              <p className="card-text" style={{overflow: 'hidden'}}>{picture?.Artist.username}</p>
            </div>
          </div>
        </div> */}
      </div >

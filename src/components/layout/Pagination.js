    ...
    <div id="Pagination">
      <nav className="d-flex justify-content-center" style={{ marginTop: 24 }} aria-label="Page navigation example">
        <ul className="pagination">
          ...
          <li className="page-item" onClick={pageOne}><a className="page-link" href="#">1</a></li>
          <li className="page-item" onClick={pagetwo}><a className="page-link" href="#">2</a></li>
          <li className="page-item" onClick={pageThree}><a className="page-link" href="#">3</a></li>
          <li className="page-item">

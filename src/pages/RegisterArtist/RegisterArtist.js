...
import { registerArtist, reset } from '../../utils/store/actions/userAction.js';
...
const RegisterArtist = _ => {
  ...
  const handleSubmit = e => {
    ...
    if (e.target?.password.value !== e.target?.confPassword.value) return console.log('PASSWORD TIDAK SAMA!');
